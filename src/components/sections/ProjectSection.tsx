            ...
            <CarouselContent className="-ml-2 md:-ml-4">
              {projectData.map((project) => (
                <CarouselItem key={project.id} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/3">
                  <motion.div 
                    className="relative bg-background/80 backdrop-blur-sm rounded-lg shadow-lg overflow-hidden h-full"
                    whileHover={{ 
                      scale: 1.05,
                      zIndex: 20,
                    ...
                    <div className="flex flex-col h-full">
                      ...
                      <div className="p-6 space-y-4 flex-1">
                        ...
                        <motion.a
                          ...
                          className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-lg text-sm mt-4"
                          whileHover={{ scale: 1.05 }}
                          whileTap={{ scale: 0.95 }}
                        >
